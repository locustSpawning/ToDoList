...
class UI {
    ...
    static initProjectButtons() {
        const inboxProjectsButton = document.getElementById('button-all-projects')
    ...
    static handleTaskButton(e) {
        if (e.target.classList.contains('fa-circle')) { //needs to be adjusted
